...
cdef extern from "../QueryEngine/Descriptors/QueryMemoryDescriptor.h":
    cdef cppclass QueryMemoryDescriptor:
        pass

cdef extern from "../Shared/TargetInfo.h":
    cdef struct TargetInfo:
        pass

cdef extern from "../QueryEngine/ResultSetReductionJIT.h":
    cdef struct ReductionCode:
        pass
